...
call <SID>X("String",		"caeb82",	"",			"none")
call <SID>X("Comment",		"ffa500",	"",			"none")
call <SID>X("Identifier",	"87afff",	"",			"none")
call <SID>X("Keyword",		"87afff",	"",			"none")
call <SID>X("Statement",	"87afff",	"",			"none")
call <SID>X("Function",		"87afff",	"",			"none")
call <SID>X("PreProc",		"e5786d",	"",			"none")
call <SID>X("Type",			"87afff",	"",			"none")
